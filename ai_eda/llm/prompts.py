...
3. For a numeric fact "value" is the number as written in the quote and "unit" the unit as written (V, mA, W, %, degC); for a range "value" is the low end and "value_high" the high end ("-40 to 125 degC": -40 and 125), otherwise "value_high" is null. The unit must fit the key (v_* volts, i_* amperes, power_rating watts, tolerance %, operating_temperature degC, theta_ja K/W or degC/W - the junction-to-ambient thermal resistance, t_j_max degC - the maximum junction temperature). For "manufacturer" and "package" "value" is the text as written, "unit" and "value_high" are null.
