...
ai-eda doctor                                      # 무엇을 찾았는지(kicad-cli, 라이브러리, ngspice 라이브러리·실행 파일, LLM 키 유무) 출력
```

| 환경 (2026-09-23) | 결과 |
|---|---|
| Windows 11 + KiCad 10.0.6(번들 ngspice.dll) — 검토 전 | 1040 passed / 5 skipped |
| Ubuntu 24.04 + `libngspice0`(ngspice-42, 자동 탐색), KiCad 없음 | 1053 passed / 80 skipped |
| Ubuntu 24.04, ngspice 없음(`NGSPICE_DLL=/nonexistent`) | 1014 passed / 119 skipped |
